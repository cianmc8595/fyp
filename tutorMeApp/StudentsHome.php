    ...
    <div class="section section-header">
        ...
        <a href="tutorSearch.php">
            <div class="app-card" id="home-card-color" style="margin-top:-80px;">
                ...
                <img src="tutorSearch.png" style="width:100%;height:100%;display: block; margin-left: auto; margin-right: auto; "></img>
                </div>
                <div class="text-container">
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            ...
                            <div class="back">
                                <p class="description">Search for tutors that suit your needs</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- DOCUMENT RESOURCES -->
        <a href="manageStudentAccount.php">
...
<div class="flexbox-container" style="margin-top:0px;">
                ...
                <div class="text-container">
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            ...
                            <div class="back">
                                <p class="description">View all on-going conversations and Review your tutors</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <a href="resources.php">
            <div class="app-card" id="volunteer-selection-ampersand-onboarding-card-color" style="margin-top:-50px;">
                <div style="margin:0 auto; width:80%; height:130px; margin-bottom:-20px;">
                    <img src="resources.png" style="width:100%;height:100%;display: block; margin-left: auto; margin-right: auto; "></img>
                </div>
                <div class="text-container">
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            ...
                            <div class="back">
                                <p class="description">Some resources to help you out!</p>
                            </div>
                        </div>
                    </div>
                </div>
