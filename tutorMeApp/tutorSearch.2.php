        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right navbar-uppercase" style="margin-top:7px; left:30px; height:0px;">
                    <li class="dropdown" style="padding-right:20px; top:-18px;">
        ...
        <div class="parallax filter filter-color-blue" style="height:1400px;">
            ...
            <div class="container">
             <div class="component" style="margin-top:150px;">
             	<h1 style="text-align:center; font-size:28px; margin-bottom:-60px;">Hi <b><?php echo $_SESSION['username']; ?>! </b>To search for a tutor, simply choose your subject below!</h1>
  <ul class="align">
    <!-- Book 1 -->
    <li>
      <figure class='book'>        
        ...
        <ul class='page'>
          ...
          <li>
        		...
        		<input name="subjectChoiceEnglish" class="btn btn-danger" type="submit" value="subjectChoiceEnglish"></input>
    ...
    <li>
      <figure class='book'>        
        ...
        <ul class='page'>
          <li></li>
          <li>
        		<input name="subjectChoiceMaths" class="btn btn-danger" type="submit" value="subjectChoiceMaths"></input>
...
<div class="login-form" style="margin-top:-100px;">
                <form action="" method="post" enctype="multipart/form-data" style="padding-bottom:50px;">
                    ...
                    <div class="form-group <?php echo (!empty($lcGrade_err)) ? 'has-error' : ''; ?>">
                		<select type="text" class="form-control" name="subjectChoiceCustom">
                    ...
                    <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
        	            <input type="text" name="schoolCustom" class="form-control" placeholder="School Attended by Tutor" value="<?php echo $username; ?>" required="required">
...
<!-- END of modified code -->
    ...
    <div class="section section-our-clients-freebie" style="height:1000px;">
        <div class="container">
            <div class="title-area">
                <h2>The following tutors are available in this subject:</h2>
...
elseif (isset($_POST['customizeSearch'])){
	...
	$choiceSchool = $_POST['schoolCustom'];
    $sql = "SELECT * FROM CVs WHERE subject = '".$choice."'";
    $result = $conn->query($sql);
	if ($choice === ""){
	...
	echo "<div class='title-area'>
                <h5>You must select a subject from above in order to see tutor search results" . $choice."</h5>
            </div>";
	
}
   
   if($_GET){ 
    if(isset($_GET['subjectChoiceEnglish'])){
        $choice = "Maths";
    }elseif(isset($_GET['subjectChoiceMaths'])){
        $choice = "Maths";
        echo "The insert function is called." . $choice;
    }
}

    
?>
		<div class="login-form form-group" style="height:auto; margin: 0 auto; padding: 10px; position: relative; width:40%;">
            <a href="#customise"><button type="submit" class="btn btn-primary btn-lg btn-block" value="Submit" style="width:100%; float: center; background:#008b9c; position: relative; margin-top:35px;">Customise Search</button></a>
        </div>
		</div>
    </div>
