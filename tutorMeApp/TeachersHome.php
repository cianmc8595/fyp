...
<!-- START of modified code -->
    ...
    <div class="section section-header">
        ...
        <a href="manageTutors.php">
            <div class="app-card" id="home-card-color" style="margin-top:-80px;">
                <div style="margin:0 auto; width:80%; height:130px; margin-bottom:-20px;">
                    <img src="manageTutors.png" style="width:100%;height:100%;display: block; margin-left: auto; margin-right: auto; "></img>
                </div>
                <div class="text-container">
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            <div class="front">
                                <p class="title">Manage Tutors</p>
                            </div>
                            <div class="back">
                                <p class="description">Manage and verify any tutors associated with you</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- DOCUMENT RESOURCES -->
        <a href="manageTeacherAccount.php">
                ...
                <div class="text-container">
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            ...
                            <div class="back">
                                <p class="description">Manage your personal information</p>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="flexbox-container" style="margin-top:0px;">
        ...
        <a href="tutorInbox.php">
            <div class="app-card" id="drop-off-location-management-card-color" style="margin-top:-50px;">
                <div style="margin:0 auto; width:80%; height:130px; margin-bottom:-20px;">
                    <img src="manageInteractions.png" style="width:100%;height:100%;display: block; margin-left: auto; margin-right: auto; "></img>
                </div>
                <div class="text-container">
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            <div class="front">
                                <p class="title">Manage Interactions</p>
                            </div>
                            <div class="back">
                                <p class="description">Monitor interactions between students and tutors</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <a href="manageReviews.php">
            <div class="app-card" id="volunteer-selection-ampersand-onboarding-card-color" style="margin-top:-50px;">
                <div style="margin:0 auto; width:80%; height:130px; margin-bottom:-20px;">
                    <img src="manageReviews.png" style="width:100%;height:100%;display: block; margin-left: auto; margin-right: auto; "></img>
                </div>
                <div class="text-container">
                    <div class="flip-container" ontouchstart="this.classList.toggle('hover');">
                        <div class="flipper">
                            <div class="front">
                                <p class="title">Manage Reviews and Ratings</p>
                            </div>
                            <div class="back">
                                <p class="description">Read and verify Tutor reviews before they go public</p>
                            </div>
                        </div>
                    </div>
                </div>
