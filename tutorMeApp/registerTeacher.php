...
if(isset($_POST['register'])){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        if ($conn_found) {
            ...
            $sql->bind_param('sss', $TeacherUsername, $TeacherUsername, $TeacherUsername);
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" enctype="multipart/form-data" style="padding-bottom:85px; margin-top:-50px;
                    ...
                    <div class="form-group <?php echo (!empty($subject_err)) ? 'has-error' : ''; ?>">
                		<select required type="text" class="form-control" name="subject">
                    		<option selected value="">Select the subject you teach</option>
                    ...
                    <div class="form-group <?php echo (!empty($school_err)) ? 'has-error' : ''; ?>">
                		<select type="text" class="form-control" name="school">
                    		<option selected value="">Select your school from the list</option><option value="Ashton School">Ashton School</option>
